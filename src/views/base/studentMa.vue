<template>
  <div id="student">
    ...
    <el-card class="box-card">
      <div slot="header" class="clearfix" style="margin-right: 20%;" >
        <el-select v-model="value.className" filterable placeholder="请选择" @change="selectClass()" style="width:20%;">
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        stuName: [{ required: true, message: "请输入学生名称", trigger: "blur" }],
        stuMobile: [{ required: true, validator: validateMobile, trigger: "blur" }],
        stuBirthDay: [{ required: true, message: "请输入生日", trigger: "blur" }],
